...
- 🧠 I build **data pipelines**, **research tooling**, and **full-stack dashboards**
- 📈 Interested in **quant research**, **ML**, and **market microstructure**
- 🛠️ Current focus: **production-quality engineering**, latency-aware data flows, clean UX
...
- Data engineering (pipelines, validation, retries, idempotency)
- Datastores (MongoDB, PostgreSQL)
- Realtime systems (WebSockets, streaming updates)

**Quant / Research**
- Time series analysis, lead–lag, rolling correlation
- Panel data construction, residualization, robustness checks
...
- 💼 **LinkedIn:** linkedin.com/in/johan-naresh  
- 🧾 **Resume:** (link below)

> If you’re building something interesting in markets, ML, or high-leverage software, I’m always open to a quick chat.

https://johannaresh.tech/resume.pdf
